...
export default class EditGet extends React.Component
{
    state={
        amount:0,
        chosenDate: new Date(),
...
return iso;
    ...
    submitData = () =>
    {
        ...
        body:JSON.stringify({debitamount:this.state.amount,description:this.state.description,transaction_id:this.props.navigation.getParam('transaction_id'),createdAt:this.getLocalDateTime()})
